...
impl Config {
    ...
    pub fn add_workspaces_to_hypr_config(&self) -> AppResult<()> {
        ...
        config_string += "# === Generated By Hyprland Virtual Machine Manager ===\n\n";
        ...
        config_string += &format!(
            "exec-once = $HOME/.local/bin/hyprland-vdm focus monitor {}\n",
            self.main_monitor
        );
        ...
        if !already_cofigured {
            ...
            config_string += "\n# === Generated By Hyprland Virtual Machine Manager ===\n\n";
